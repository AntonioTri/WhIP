...
class TableGenerator{
    ...
    func generateCurrentTable() -> [[Int]]{
        ...
        let choosedCombination = chooseCurrentCombination(next: false)
        let nextChoosedCombination = chooseCurrentCombination(next: true)
    ...
    private func chooseCurrentCombination(next: Bool) -> [Int] {
