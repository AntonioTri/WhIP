...
class FishTemplate {
    ...
    private func getTakeRope(){
        ...
        if type < 3 {
            ...
            self.takeRopeMedium = 3
            self.takeRopeHeavy = 5
    ...
    private func getLoseRope(){
        ...
        if type < 3 {
            ...
            self.loseRopeHigh = 5
            self.loseRopeMedium = 4
            self.loseRopeLight = 2
            
        } else if type >= 7 && type <= 9 {
            
            self.loseRopeHigh = 4
            self.loseRopeMedium = 2
